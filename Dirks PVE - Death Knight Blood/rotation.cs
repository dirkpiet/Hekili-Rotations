...
{
    public class DirksPVEDeathKnightBlood : Rotation
    {
        #region Variables
        string FiveLetters;
        #endregion
        ...
        private List<string> m_SpellBook_General = new List<string> {
            ...
            //Blood
            "Blood Boil", "Blood Tap",
            "Dancing Rune Weapon", "Death's Caress", "Gorefiend's Grasp", "Heart Strike",
            "Marrowrend", "Asphyxiate", "Rune Tap", "Tombstone",
            "Vampiric Blood", "Glacial Advance", "Breath of Sindragosa",
            "Death Pact",
        };
        ...
        public override void LoadSettings()
        {
            ...
            Settings.Add(new Setting("Ingame World Latency:", 1, 200, 20));
        ...
        public override void Initialize()
        {
            ...
            Aimsharp.PrintMessage("Dirks PVE - Death Knight Blood", Color.Blue);
        ...
        public override bool CombatTick()
        {
            ...
            //Auto Dancing Rune Weapon -- Till here
            if(Aimsharp.CanCast("Dancing Rune Weapon", "player", false, true))
            {
                if(Aimsharp.EnemiesInMelee() >= 5 || PlayerHP <= GetSlider("Auto Dancing Rune Weapon @ HP%")){
                    Aimsharp.Cast("Dancing Rune Weapon");
                    return true;
                }
            }
            ...
            if (Aimsharp.TargetIsEnemy() && TargetAlive() && TargetInCombat)
            {
                if (Wait <= 200)
                {
                    ...
                    if (SpellID1 == 312202 && Aimsharp.CanCast("Shackle the Unworthy", "player", false, true) && Aimsharp.Range("target") <= 5)
                    {
                    ...
                    ////Player
                    if (SpellID1 == 50842 && Aimsharp.CanCast("Blood Boil", "player", false, true) && Aimsharp.Range("target") <= 5)
                    {
                        Aimsharp.Cast("Blood Boil");
                        return true;
                    }

                    if (SpellID1 == 221699 && Aimsharp.CanCast("Blood Tap", "player", false, true) && Aimsharp.Range("target") <= 5)
                    {
                        Aimsharp.Cast("Blood Tap");
                        return true;
                    }

                    if (SpellID1 == 108199 && Aimsharp.CanCast("Gorefiend's Grasp", "player", false, true) && Aimsharp.Range("target") <= 5)
                    {
                        Aimsharp.Cast("Gorefiend's Grasp");
                        return true;
                    }

                    if (SpellID1 == 194679 && Aimsharp.CanCast("Rune Tap", "player", false, true) && Aimsharp.Range("target") <= 5)
                    {
                        Aimsharp.Cast("Rune Tap");
                        return true;
                    }

                    if (SpellID1 == 219809 && Aimsharp.CanCast("Tombstone", "player", false, true) && Aimsharp.Range("target") <= 5)
                    {
                        Aimsharp.Cast("Tombstone");
                        return true;
                    }

                    if (SpellID1 == 55233 && Aimsharp.CanCast("Vampiric Blood", "player", false, true) && Aimsharp.Range("target") <= 5)
                    {
                        Aimsharp.Cast("Vampiric Blood");
                        return true;
                    }           
                    ...
                    ////Target
                    if (SpellID1 == 195182 && Aimsharp.CanCast("Marrowrend", "player", false, true) && Aimsharp.Range("target") <= 5)
                    {
                        Aimsharp.Cast("Marrowrend");
                        return true;
                    }

                    if (SpellID1 == 195292 && Aimsharp.CanCast("Death's Caress", "player", false, true) && Aimsharp.Range("target") <= 5)
                    {
                        Aimsharp.Cast("Death's Caress");
                        return true;
                    }

                    if (SpellID1 == 206930 && Aimsharp.CanCast("Heart Strike", "player", false, true) && Aimsharp.Range("target") <= 5)
                    {
                        Aimsharp.Cast("Heart Strike");
                        return true;
                    }
