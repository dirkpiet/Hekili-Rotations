...
namespace AimsharpWow.Modules
{
    public class SnoogensPVEWarlockDemonology : Rotation
    {
        ...
        public override void Initialize()
        {
            ...
            Aimsharp.PrintMessage("Snoogens PVE - Warlock Demonology", Color.Yellow);
            ...
            Aimsharp.PrintMessage("/xxxxx BilescourgeBombers - Casts Bilescourge Bombers @ next GCD", Color.Yellow);
            Aimsharp.PrintMessage("/xxxxx BilescourgeBombersCursor - Toggles Bilescourge Bombers always @ Cursor (same as Option)", Color.Yellow);
            Aimsharp.PrintMessage("-----", Color.Black);
