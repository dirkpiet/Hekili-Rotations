...
{
    public class SnoogensPVEDeathKnightUnholy : Rotation
    {
        #region Variables
        string FiveLetters;
        #endregion
        ...
        private List<string> m_SpellBook_General = new List<string> {
            ...
            "Apocalypse", "Raise Dead", "Army of the Dead", "Scourge Strike",
            "Dark Transformation", "Epidemic", "Festering Strike", "Outbreak",
            "Clawing Shadows", "Unholy Blight", "Asphyxiate", "Soul Reaper",
            "Wraith Walk", "Death Pact", "Defile", "Summon Gargoyle", "Unholy Assault",
        };
        ...
        public override void Initialize()
        {
            ...
            Aimsharp.PrintMessage("Snoogens PVE - Death Knight Unholy", Color.Yellow);
            ...
            Aimsharp.PrintMessage("/xxxxx ArmyoftheDead - Casts Army of the Dead @ next GCD", Color.Yellow);
        ...
        public override bool CombatTick()
        {
            ...
            if (Aimsharp.SpellCooldown("Army of the Dead") - Aimsharp.GCD() > 2000 && ArmyoftheDead)
            {
                Aimsharp.Cast("ArmyoftheDeadOff");
                return true;
            }

            if (ArmyoftheDead && Aimsharp.CanCast("Army of the Dead", "player", false, true))
            {
                Aimsharp.Cast("Army of the Dead");
                return true;
            }
            ...
            if (Aimsharp.TargetIsEnemy() && TargetAlive() && TargetInCombat)
            {
                if (Wait <= 200)
                {
                    ...
                    ////Player
                    if (SpellID1 == 275699 && Aimsharp.CanCast("Apocalypse", "player", false, true) && Aimsharp.Range("target") <= 5)
                    {
                        Aimsharp.Cast("Apocalypse");
                        return true;
                    }

                    if (SpellID1 == 42650 && Aimsharp.CanCast("Army of the Dead", "player", false, true) && Aimsharp.Range("target") <= 5)
                    {
                        Aimsharp.Cast("Army of the Dead");
                        return true;
                    }

                    if (SpellID1 == 46584 && Aimsharp.CanCast("Raise Dead", "player", false, true))
                    {
                        Aimsharp.Cast("Raise Dead");
                        return true;
                    }

                    if (SpellID1 == 63560 && Aimsharp.CanCast("Dark Transformation", "pet", true, true) && Aimsharp.Range("target") <= 5)
                    {
                        Aimsharp.Cast("Dark Transformation");
                        return true;
                    }

                    if (SpellID1 == 207317 && Aimsharp.CanCast("Epidemic", "player", false, true) && Aimsharp.Range("target") <= 5)
                    {
                        Aimsharp.Cast("Epidemic");
                        return true;
                    }

                    if (SpellID1 == 115989 && Aimsharp.CanCast("Unholy Blight", "player", false, true) && Aimsharp.Range("target") <= 5)
                    {
                        Aimsharp.Cast("Unholy Blight");
                        return true;
                    }

                    if (SpellID1 == 49206 && Aimsharp.CanCast("Summon Gargoyle", "player", false, true) && Aimsharp.Range("target") <= 5)
                    {
                        Aimsharp.Cast("Summon Gargoyle");
                        return true;
                    }

                    if (SpellID1 == 207289 && Aimsharp.CanCast("Unholy Assault", "player", false, true) && Aimsharp.Range("target") <= 5)
                    {
                        Aimsharp.Cast("Unholy Assault");
                        return true;
                    }

                    if (SpellID1 == 212552 && Aimsharp.CanCast("Wraith Walk", "player", false, true))
                    {
                        Aimsharp.Cast("Wraith Walk");
                        return true;
                    }

                    if (SpellID1 == 48743 && Aimsharp.CanCast("Death Pact", "player", false, true))
                    {
                        Aimsharp.Cast("Death Pact");
                        return true;
                    }
                    ...
                    ////Target
                    if (SpellID1 == 77575 && Aimsharp.CanCast("Outbreak", "target", true, true))
                    {
                        Aimsharp.Cast("Outbreak");
                        return true;
                    }

                    if (SpellID1 == 108194 && Aimsharp.CanCast("Asphyxiate", "target", true, true))
                    {
                        Aimsharp.Cast("Asphyxiate");
                        return true;
                    }

                    if (SpellID1 == 55090 && Aimsharp.CanCast("Scourge Strike", "target", true, true))
                    {
                        Aimsharp.Cast("Scourge Strike");
                        return true;
                    }

                    if (SpellID1 == 85948 && Aimsharp.CanCast("Festering Strike", "target", true, true))
                    {
                        Aimsharp.Cast("Festering Strike");
                        return true;
                    }

                    if (SpellID1 == 207311 && Aimsharp.CanCast("Clawing Shadows", "target", true, true))
                    {
                        Aimsharp.Cast("Clawing Shadows");
                        return true;
                    }

                    if (SpellID1 == 343294 && Aimsharp.CanCast("Soul Reaper", "target", true, true))
                    {
                        Aimsharp.Cast("Soul Reaper");
                        return true;
                    }
                    #endregion
        ...
        public override bool OutOfCombatTick()
        {
            ...
            if (SpellID1 == 46584 && Aimsharp.CanCast("Raise Dead", "player", false, true) && !Moving)
            {
                Aimsharp.Cast("Raise Dead");
                return true;
            }
