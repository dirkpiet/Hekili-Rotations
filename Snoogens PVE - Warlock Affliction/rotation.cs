...
namespace AimsharpWow.Modules
{
    public class SnoogensPVEWarlockAffliction : Rotation
    {
        ...
        private void InitializeMacros()
        {
            ...
            Macros.Add("VileTaintP", "/cast [@player] Vile Taint");
        }
        ...
        public override bool CombatTick()
        {
            ...
            if (Aimsharp.IsCustomCodeOn("VileTaint") && Aimsharp.SpellCooldown("Vile Taint") - Aimsharp.GCD() <= 0 && Aimsharp.CustomFunction("IsRMBDown") == 1)
            {
                return false;
            }
            #endregion
            ...
            if ((Aimsharp.SpellCooldown("Vile Taint") - Aimsharp.GCD() > 2000 || Moving) && VileTaint)
            {
                if (Debug)
                {
            ...
            if (VileTaint && Aimsharp.CanCast("Vile Taint", "player", false, true) && !Moving)
            {
            ...
            if (Aimsharp.TargetIsEnemy() && TargetAlive() && TargetInCombat && Wait <= 200)
            {
                if (Aimsharp.Range("target") <= 40 && !Aimsharp.HasDebuff("Banish", "target", true) && !Aimsharp.HasDebuff("Fear", "target", true) && !Banish && !Fear)
                {
                    ...
                    */
                    ...
                    if (SpellID1 == 278350 && Aimsharp.CanCast("Vile Taint", "player", false, true) && ((Aimsharp.CustomFunction("VileTaintMouseover") == 1 || !InstanceIDList.Contains(Aimsharp.GetMapID()) && Aimsharp.CustomFunction("VileTaintMouseoverNC") == 1) || GetCheckBox("Always Cast Vile Taint @ Cursor during Rotation") || Aimsharp.IsCustomCodeOn("VileTaintCursor")))
                    {
                        if (Debug)
                        {
                    ...
                    else if (SpellID1 == 267211 && Aimsharp.CanCast("Vile Taint", "player", false, true))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 324536 && Aimsharp.CanCast("Malefic Rapture", "player", false, true))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 205180 && Aimsharp.CanCast("Summon Darkglare", "player", false, true))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 113860 && Aimsharp.CanCast("Dark Soul: Misery", "player", false, true))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 48181 && Aimsharp.CanCast("Haunt", "target", true, true))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 205179 && Aimsharp.CanCast("Phantom Singularity", "target", true, true))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 63106 && Aimsharp.CanCast("Siphon Life", "target", true, true))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 198590 && Aimsharp.CanCast("Drain Soul", "target", true, true))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 980 && Aimsharp.CanCast("Agony", "target", true, true))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 27243 && Aimsharp.CanCast("Seed of Corruption", "target", true, true))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 316099 && Aimsharp.CanCast("Unstable Affliction", "target", true, true))
                    {
                        if (Debug)
                        {
