...
{
    public class SnoogensPVEMageArcane : Rotation
    {
        #region Variables
        string FiveLetters;
        #endregion
        ...
        private List<string> m_SpellBook = new List<string> {
            ...
            "Summon Steward", "Fleshcraft", "DoorofShadows"
        ...
        public override bool CombatTick()
        {
            ...
            if (Aimsharp.CanCast("Greater Invisibility", "player", false, true))
            {
                if (PlayerHP <= GetSlider("Auto Greater Invisibility @ HP%"))
                {
                    ...
                    if (Debug)
                    {
                        Aimsharp.PrintMessage("Casting Greater Invisibility - Player HP% " + PlayerHP + " due to setting being on HP% " + GetSlider("Auto Greater Invisibility @ HP%"), Color.Purple);
                    }
                    return true;
                }
            }
            ...
            if (Aimsharp.CanCast("Prismatic Barrier", "player", false, true))
            {
                if (PlayerHP <= GetSlider("Auto Prismatic Barrier @ HP%"))
                {
                    Aimsharp.Cast("Prismatic Barrier");
                    if (Debug)
                    {
                        Aimsharp.PrintMessage("Casting Prismatic Barrier - Player HP% " + PlayerHP + " due to setting being on HP% " + GetSlider("Auto Prismatic Barrier @ HP%"), Color.Purple);
                    }
                    return true;
                }
            }
            ...
            if (Evocation && Aimsharp.CanCast("Evocation", "player", false, true) && !Moving)
            {
                if (Debug)
                {
            ...
            if (Aimsharp.TargetIsEnemy() && TargetAlive() && TargetInCombat && Wait <= 200)
            {
                if (Aimsharp.Range("target") <= 40 && !Aimsharp.HasDebuff("Polymorph", "target", true) && !Polymorph && !ArcaneExplosion)
                {
                    ...
                    //Target - GCD
                    if (SpellID1 == 44425 && Aimsharp.CanCast("Arcane Barrage", "target", true, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Arcane Barrage - " + SpellID1, Color.Purple);
                        }
                        Aimsharp.Cast("Arcane Barrage");
                        return true;
                    }
                    ...
                    if (SpellID1 == 30451 && Aimsharp.CanCast("Arcane Blast", "target", true, true) && (!Moving || Aimsharp.HasBuff("Presence of Mind", "player", true)))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Arcane Blast - " + SpellID1, Color.Purple);
                        }
                        Aimsharp.Cast("Arcane Blast");
                        return true;
                    }

                    if (SpellID1 == 5143 && Aimsharp.CanCast("Arcane Missiles", "target", true, true) && !Moving)
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Arcane Missiles - " + SpellID1, Color.Purple);
                        }
                        Aimsharp.Cast("Arcane Missiles");
                        return true;
                    }

                    if (SpellID1 == 319836 && Aimsharp.CanCast("Fire Blast", "target", true, true))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 116 && Aimsharp.CanCast("Frostbolt", "target", true, true))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 114923 && Aimsharp.CanCast("Nether Tempest", "target", true, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Nether Tempest - " + SpellID1, Color.Purple);
                        }
                        Aimsharp.Cast("Nether Tempest");
                        return true;
                    }

                    if (SpellID1 == 118 && Aimsharp.CanCast("Polymorph", "target", true, true))
                    {
                        if (Debug)
                        {
                    ...
                    if (SpellID1 == 31589 && Aimsharp.CanCast("Slow", "target", true, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Slow - " + SpellID1, Color.Purple);
                        }
                        Aimsharp.Cast("Slow");
                        return true;
                    }
                    ...
                    if (SpellID1 == 157980 && Aimsharp.CanCast("Supernova", "target", true, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Supernova - " + SpellID1, Color.Purple);
                        }
                        Aimsharp.Cast("Supernova");
                        return true;
                    }

                    if (SpellID1 == 321507 && Aimsharp.CanCast("Touch of the Magi", "target", true, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Touch of the Magi - " + SpellID1, Color.Purple);
                        }
                        Aimsharp.Cast("Touch of the Magi");
                        return true;
                    }
                    #endregion
                    ...
                    if (SpellID1 == 999999 && Aimsharp.CanUseItem("Mana Gem", false))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Using Mana Gem - " + SpellID1, Color.Purple);
                        }
                        Aimsharp.Cast("ManaGem");
                        return true;
                    }
                    ...
                    if (SpellID1 == 205022 && Aimsharp.CanCast("Arcane Familiar", "player", false, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Arcane Familiar - " + SpellID1, Color.Purple);
                        }
                        Aimsharp.Cast("Arcane Familiar");
                        return true;
                    }
                    ...
                    if (SpellID1 == 153626 && Aimsharp.CanCast("Arcane Orb", "player", false, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Arcane Orb - " + SpellID1, Color.Purple);
                        }
                        Aimsharp.Cast("Arcane Orb");
                        return true;
                    }

                    if (SpellID1 == 12042 && Aimsharp.CanCast("Arcane Power", "player", false, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Arcane Power - " + SpellID1, Color.Purple);
                        }
                    ...
                    if (SpellID1 == 759 && Aimsharp.CanCast("Conjure Mana Gem", "player", false, true) && !Moving)
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Conjure Mana Gem - " + SpellID1, Color.Purple);
                        }
                        Aimsharp.Cast("Conjure Mana Gem");
                        return true;
                    }

                    if (SpellID1 == 12051 && Aimsharp.CanCast("Evocation", "player", false, true) && !Moving)
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Evocation - " + SpellID1, Color.Purple);
                        }
                        Aimsharp.Cast("Evocation");
                        return true;
                    }
                    ...
                    if (SpellID1 == 110959 && Aimsharp.CanCast("Greater Invisibility", "player", false, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Greater Invisibility - " + SpellID1, Color.Purple);
                        }
                        Aimsharp.Cast("Greater Invisibility");
                        return true;
                    }
                    ...
                    if (SpellID1 == 205025 && Aimsharp.CanCast("Presence of Mind", "player", false, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Presence of Mind - " + SpellID1, Color.Purple);
                        }
                        Aimsharp.Cast("Presence of Mind");
                        return true;
                    }

                    if (SpellID1 == 235450 && Aimsharp.CanCast("Prismatic Barrier", "player", false, true))
                    {
                        if (Debug)
                        {
                            Aimsharp.PrintMessage("Casting Prismatic Barrier - " + SpellID1, Color.Purple);
                        }
                        Aimsharp.Cast("Prismatic Barrier");
                        return true;
                    }
